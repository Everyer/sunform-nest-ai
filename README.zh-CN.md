...
| 💬 **实时聊天** | 基于 WebSocket 的 IM：系统用户、单聊与群聊、打字与已读回执、桌面通知 |
| 📊 **在线 Excel** | 基于 [Univer](https://github.com/dream-num/univer) 的电子表格编辑器：公式栏、条件格式、冻结窗格、工作表标签 |
| 📂 **万能文件在线预览** | 浏览器内直接预览 PDF / Word / 图片 / 结构化思维导图，无需插件、无需下载 |
...
### 4. 在线协作：文件预览 / 聊天 / Excel

| ![万能文件在线预览](docs/screenshots/万能文件在线预览.png) | ![在线聊天](docs/screenshots/在线聊天.png) |
|:---:|:---:|
| **万能文件在线预览**：浏览器内直接打开 PDF / Word / 图片 / 结构化思维导图,无需下载 | **基于 WebSocket 的在线聊天**：系统用户、单聊与群聊、打字与已读回执、桌面通知提醒 |

| ![在线 Excel](docs/screenshots/在线excel.png) |  |
|:---:|:---:|
| **基于 [Univer](https://github.com/dream-num/univer) 的在线 Excel**：公式栏、条件格式、冻结窗格、工作表标签,聊天窗口可停靠侧栏 |  |
