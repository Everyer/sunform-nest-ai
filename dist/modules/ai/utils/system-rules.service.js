...
exports.SystemRulesService = void 0;
const common_1 = require("@nestjs/common");
let SystemRulesService = class SystemRulesService {
    constructor() {
        this.SYSTEM_RULES = {
...
现在根据用户需求，生成 homepage 下的 widgetList 骨架。
   `,
    ...
    getSystemRuleContent(ruleType, customContent) {
        if (ruleType === 'custom') {
    ...
    getSystemMessage(ruleType = 'default', customContent) {
    ...
    addSystemRules(messages, ruleType = 'default', customContent) {
...
exports.SystemRulesService = SystemRulesService;
exports.SystemRulesService = SystemRulesService = __decorate([
    (0, common_1.Injectable)()
], SystemRulesService);
//# sourceMappingURL=system-rules.service.js.map